...
export default function FeaturedBlog({ post }: BlogProps) {
  ...
  return (
    <div className="container mx-auto h-68 aspect-video rounded-xl shadow-sm bg-base-100 text-base-content flex flex-col md:flex-row gap-6 items-start">
    {/* Left: Image */}
    ...
    <div className="md:w-3/5 w-full space-y-4 p-2">
      ...
      <h2 className="text-2xl font-bold line-clamp-2 text-base-content">
        {post.title}
      </h2>
